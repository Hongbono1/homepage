...
<body class="bg-gray-50">
  ...
  <script>
    ...
    document.addEventListener("DOMContentLoaded", () => {
      ...
      if (rankingList) {
        const searchRanking = [
          { name: "응급실 운영 시간", link: "search.php?keyword=응급실+운영+시간" },
          { name: "병원 예약",       link: "search.php?keyword=병원+예약" },
          { name: "응급실 위치",     link: "search.php?keyword=응급실+위치" },
          { name: "응급실 대기시간", link: "search.php?keyword=응급실+대기시간" },
          { name: "응급실 후기",     link: "search.php?keyword=응급실+후기" }
        ];
